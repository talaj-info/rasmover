...
#http://stackoverflow.com/a/9228117/2334951
...
class PointTool(QgsMapTool):
        ...
        def canvasReleaseEvent(self, event):
            ...
            dbName = os.getenv("HOME").decode('utf8') + u'/.qgis2/python/plugins/rasmover/temp/coords'
            ...
            out_folder = os.getenv("HOME").decode('utf8') + u'/.qgis2/python/plugins/rasmover/temp'
            if _platform == "win32":
               out_folder = out_folder.replace( u"\\", u"/")

#            print("%s\n") %(out_folder)

            listaRaster = out_folder + u'/lista.txt'
            ...
            for iLayer in range(self.canvas.layerCount()):
                 ...
                 if layer.type() == layer.RasterLayer:
                      if (layer.name() == "moved"):
                         ...
                         fileIMAGE = layer.source()
                         scrivimi = (u"%s\n") %(fileIMAGE)
                         f5.write( scrivimi.encode('utf8') )
